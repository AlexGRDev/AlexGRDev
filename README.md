...
Currently studying at **42 Barcelona** (since September 22, 2025).  
I completed the **42 Piscine** from **July 1–28, 2025**, where I built strong foundations in C, Shell scripting and algorithmic problem-solving.

My background includes **IT Support**, **system administration basics**, and hands-on work with **Linux**, networks, and troubleshooting.  
I'm especially interested in cybersecurity, low-level programming and infrastructure management.
...
| ![R2](https://img.shields.io/badge/R2-%23000000) | [Push_Swap](https://github.com/AlexGRDev/42_Master/tree/main/Rank%202/push_swap) | A C algorithm that sorts numbers using stacks with minimal operations | C | ![Score](https://img.shields.io/badge/Progress-In%20Progress-808080?style=for-the-badge) |
...
### **IT Support – Team Leader (Internship)**  
**Sant Andreu Municipal School, Barcelona**  
*May 2023 – December 2023*  
- Classroom and user IT support  
- Hardware/software troubleshooting (Tier 1–2)  
- Basic network and system admin tasks  

### **Computer Assistant**  
**CactusCat, Barcelona**  
*June 2022 – September 2022*  
- Equipment maintenance and troubleshooting  
- Basic local network assistance  
